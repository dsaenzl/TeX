...
\newcommand{\nc}[2][w]{ %Las lineas superiores de las cajas
...
\newtcolorbox{conceptbox}[2][]{
	...
	size=fbox,
	colback=w, %Color de las "cajas" de información
	...
	bottom=1pt,
	boxrule=1pt,
	coltitle=b, %Color del titulo caja
	colupper=b, %Color del "upper"
	pad at break=5pt,
...
\begin{minipage}{\textwidth} %title
	\tikz{
		...
		\node[anchor=west, fill = w, inner sep = 3pt, text=b] at (0,0) {\textbf{FORMULAS}};
		\node[anchor=east, fill = w, inner sep = 3pt, text=b] at (\textwidth,0) {\textbf{DAVID}};
	}
\end{minipage}
...
\begin{multicols*}{4}
	...
	\end{conceptbox}
	\columnbreak
	\begin{conceptbox}[g2]{Tikz Diagrams}
		\tiny
